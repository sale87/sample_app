...
describe UsersController do
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = Factory(:user, :email => "user@example.net", :name => "Wrong User")
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :email => "another@example.com", :name => "Example Name 1")
        third  = Factory(:user, :email => "another@example.net", :name => "Example Name 2")
